          ...
          <form action="">
            <div>
              ...
              <div className="flex ease-in-out duration-500 transition-transform my-1 bg-white space-x-2 focus-within:scale-105 hover:scale-105 px-2 py-2 w-full overflow-hidden rounded-full ">
                ...
                />
                <button className="flex justify-center transition-all ease-in-out duration-300 items-center space-x-1 px-3 bg-indigo-600 text-white hover:bg-white border-indigo-600 border-2 hover:text-indigo-600 rounded-full">
